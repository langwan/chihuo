...
type ServerClient interface {
	...
	PanicMethod(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *serverClient) PanicMethod(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/Server/PanicMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServerServer interface {
	...
	PanicMethod(context.Context, *Empty) (*Empty, error)
}
...
func (UnimplementedServerServer) PanicMethod(context.Context, *Empty) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PanicMethod not implemented")
}
...
func _Server_PanicMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServerServer).PanicMethod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Server/PanicMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServer).PanicMethod(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Server_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Server_PanicMethod_Handler,
		},
	},
